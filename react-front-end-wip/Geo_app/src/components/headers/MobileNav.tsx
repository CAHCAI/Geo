    ...
    <div className="lg:hidden max-w-screen-xl mx-auto flex flex-col items-center justify-center ">
      ...
      <div className="py-5 px-3">
        <ul className=" flex flex-wrap items-center gap-5 text-sm ">
          <li className=" group cursor-pointer hover:text-blue-500 dark:text-white dark:hover:text-blue-500 text-blue-900 transition-all duration-200 ease-linear">
          ...
          <li className=" group cursor-pointer hover:text-blue-500 text-blue-900 transition-all duration-200 ease-linear dark:text-white dark:hover:text-blue-500">
          ...
          <li className=" border rounded-3xl px-3 py-1 font-bold text-blue-700 border-blue-600 cursor-pointer hover:bg-blue-600 hover:text-white transition-all duration-200 ease-linear dark:text-white dark:hover:bg-blue-500 dark:hover:text-white">
            LOG IN
          </li>
          <li>
            <ThemeToggle />
      ...
      <div className=" bg-blue-800 dark:bg-gray-900 w-full py-5 px-3">
